...
Route::delete('/wishlist/clear',[WishlistController::class,'empty_cart'])->name('wishlist.items.clear');
Route::post('/wishlist/move-to-cart/{rowId}', [WishlistController::class, 'move_to_card'])->name('wishlist.move.to.cart');
