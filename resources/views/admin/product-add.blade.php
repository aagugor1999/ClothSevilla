        ...
        <div class="main-content-wrap">
            ...
            <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{ route('admin.product.store') }}" >
                ...
                <div class="wg-box">
                    ...
                    @error('instock') <span class="alert alert-danger text-center">{{$message}}</span> @enderror  
                        <fieldset class="name">
...
<script>
    $(function () {
        ...
        $("#gFile").on("change", function (e) {
            ...
            // Mostrar todas las imágenes acumuladas
            selectedFiles.forEach((file) => {
                const imgPreview = `<div class="item gitems"><img src="${URL.createObjectURL(file)}" ></div>`;
                $("#galUpload").prepend(imgPreview);
            });

            // Crear nuevo objeto DataTransfer para asignar todos los archivos al input
