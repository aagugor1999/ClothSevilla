                        ...
                        <div class="sticky-content">
                                ...
                                @if (Session::has('discounts'))
                                    <table class="checkout-totals">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Discounts {{ Session::get('coupon')['code'] }}</th>
                            ...
                            <div class="checkout__payment-methods">
                                <div class="form-check">
                                    <input class="form-check-input form-check-input_fill" type="radio" value="transfer"
                                        name="mode" id="mode4" checked>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input form-check-input_fill" type="radio" value="card"
                                        name="mode" id="mode1">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input form-check-input_fill" type="radio" value="paypal"
                                        name="mode" id="mode2">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input form-check-input_fill" type="radio" value="cod"
                                        name="mode" id="mode3">
